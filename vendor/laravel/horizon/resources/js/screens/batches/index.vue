        ...
        <div class="card overflow-hidden">
            ...
            <table v-if="ready && batches.length > 0" class="table table-hover mb-0">
                ...
                <tr v-for="batch in batches" :key="batch.id">
                    ...
                    <td>
                        <small class="badge text-bg-danger badge-sm" v-if="!batch.cancelledAt && batch.failedJobs > 0 && batch.totalJobs - batch.pendingJobs < batch.totalJobs">
                            Failures
                        </small>
                        <small class="badge text-bg-success badge-sm" v-if="!batch.cancelledAt && batch.totalJobs - batch.pendingJobs == batch.totalJobs">
                            Finished
                        </small>
                        <small class="badge badge-secondary badge-sm" v-if="!batch.cancelledAt && batch.pendingJobs > 0 && !batch.failedJobs">
                            Pending
                        </small>
                        <small class="badge text-bg-warning badge-sm" v-if="batch.cancelledAt">
                            Cancelled
                        </small>
                    </td>
