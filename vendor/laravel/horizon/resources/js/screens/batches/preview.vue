            ...
            <div class="card-body card-bg-secondary" v-if="ready">
                <div class="row mb-2">
                    ...
                    <div class="col">
                        ...
                        <small class="ms-1 badge text-bg-danger badge-sm" v-if="batch.failedJobs > 0 && batch.totalJobs - batch.pendingJobs < batch.totalJobs">
                            Failures
                        </small>
                        <small class="ms-1 badge text-bg-success badge-sm" v-if="batch.totalJobs - batch.pendingJobs == batch.totalJobs">
                            Finished
                        </small>
