 ...
 */
export const getFormFieldValue = (value, options, isDefault, type = '', id = "", from="") => {

  if(from === 'automator' && type === 'htmltextarea') return value ? value.replace(/<\/?p>/g, '') : value;
 ...
 */
export const getValueToSubmit = (value, isDefault, optionLabel = 'label', id='', appendValue="", element_type=null) => {

  if (value === undefined) return;

  if(element_type === 'htmltextarea') return value ? '<p>'+value.replace(/<\/?p>/g, '')+'</p>' : value;
