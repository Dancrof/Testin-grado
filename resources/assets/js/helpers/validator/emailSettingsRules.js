...
export function validateEmailSettings(data){
    ...
    const { email_address, email_name, password, fetching_protocol, fetching_host,fetching_status, fetching_encryption,
        ...
        api_key, secret, domain, region, version, is_oauth} = data;
    ...
    (shallPasswordBeVisble(data)) && !is_oauth && (validatingData.password = [password, 'isRequired', 'min(3)', 'max(255)']);
...
export function discoverEmailSettings(data){
