	...
	<div>
    	...
    	<modal :showModal="show" :onClose="closeModal">
			...
			<template #fields>
				...
				<div v-show="!isChildFormLoading" id="user-form-modal-body" :class="formId === 'chat-widget' ? 'ps-2' : ''">
					...
					<form-with-captcha v-if="formUniqueKey && formSelected" :loading="!isChildFormLoading" btnClass='btn btn-custom pull-right text-white' btnName="submit"
						...
						btn_id="user-submit" :formSubmit="formSubmit" :page="formId === 'chat-widget' ? 'chat-widget' : panel === 'client' ? 'requester_create_client' : 'requester_create_agent'"
