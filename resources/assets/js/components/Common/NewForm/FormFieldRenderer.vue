<template>
	...
	<div class="ps-3 pe-3 pt-2">
		...
		<TinyMCEWithValidation v-if="formField.data_type ==='htmltextarea'" :id="formField.key"
			...
			:attachments="attachments" from="ticket"
    ...
    <div class="d-flex justify-content-end">
      <div class="form-check checkbox multi-requester-checkbox text-end me-1" v-if="showMultiRequesterCheckbox">
      ...
      callingFrom: { type : String, default : ''},
		...
		computed: {
			...
			apiInfoUrl() {
				...
				if(this.formField.title === 'Api' && !apiUrl) {
      ...
      shouldCheckTicketStatus() {
		...
		methods: {
			...
			getSimplePlaceholder(type) {
				...
				else if(type === 'number'){ placeholder = 'integer'; }

				else if(type === 'decimal'){ placeholder = 'decimal_number'; }
