<template>
	...
	<div id="form-with-recaptcha">
		...
		<div :class="recaptchaContainerClass" v-if="loading">
			...
			<RecaptchaField v-if="page !== 'chat-widget'" :key="'captcha'+counter" v-captcha="page" :verifyCaptcha="getCaptcha" name="captcha">
	...
	export default {
		...
		methods : {
			...
			onSubmit() {
				...
				if(this.page && this.recaptchaApplyfor && this.recaptchaApplyfor.includes(this.page)){
