<template>
  ...
  <div class="media-lib">
    ...
    <button type="button" class="btn btn-light media-btn" data-bs-toggle="modal" data-bs-target="#myModal"
      @click="getGallery()">
      ...
      <div class="modal-dialog modal-xl" >
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary btn-md" :disabled="disableBtn" @click="showModal = true">
