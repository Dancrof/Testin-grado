		...
		<div class="row">
			...
			<div class="col-md-6" v-if="hasDataPopulated">
              ...
              <number-field :label="lang('ext')" :value="ext" name="ext" classname="col-sm-3"
						...
						<phoneWithCountryCode id="mobile" name="mobile" :onChange="onChange" :value="mobile" :countryCode="country_code"
							@countCode="getCountCode" :countryIso="iso" @countIso="getCountIso" fieldType="FIXED_LINE_OR_MOBILE"   @validPhoneNumber="checkValidity">

						</phoneWithCountryCode>


						<tiny-editor :value="agent_sign" type="text" id="agent_sign_editor" :onChange="onChange" name="agent_sign" :label="lang('agent_sign')"
							classname="" :lang="'en'">
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<button v-if="!two_factor" type="button" class="btn btn-primary float-end" @click="showModal = true" :disabled="profileData.is_otp_verification_enabled" v-tooltip="lang('google_2fa_tooltip_for_status_' + !profileData.is_otp_verification_enabled)">
								...
								<button v-if="two_factor" type="button" class="btn btn-secondary float-end" @click="removeModal = true">
									...
									<i class="fas fa-toggle-off"></i> {{lang('turn_off')}}
            ...
            <div id="profile-view-boxes">{{profileBoxVisible()}}</div>
				...
				<transition name="modal">
					...
					<barcode-modal v-if="showModal" :onClose="onClose" :two_factor="true" :showModal="showModal">
