                ...
                <div class="modal-width">
                    ...
                    <ul class="nav nav-tabs" role = "tablist" v-if="tabsToShow.length">
                        <li class="nav-item" v-for="tab in tabsToShow" :key="tab.id" :id="tab.id">
                            <a href="javascript:void(0)" :class="['nav-link', currentTab === tab.value ? 'active' : '']" @click="onTabChange(tab.value)" data-bs-toggle="pill" role="tab">{{lang(tab.value)}}</a>
                        </li>
                    </ul>
                            ...
                            <div>
                                ...
                                <div class="table">
                                    <ul id="horizontal-list">
                                        ...
                                        <li class="add-option-loader float-end" v-if="isLoading">
                                            <loader :size="20" />
                                        </li>
                                    </ul>
                                </div>
