<template>
	...
	<div id="respond" class="comment-respond form-border">
		...
		<form-with-captcha btnClass="btn btn-custom btn-lg ms-auto" :btnStyle="buttonStyle"
			...
			<template #fields>
				...
				<div class="row">
					...
					<div class="col-sm-4"  v-if="Array.isArray(auth.user_data)">
						...
						<text-field :label="lang('email')" :value="email" type="text" defaultKey="email" name="email" id="kb_comment_email"
									:onChange="onChange" :required="true" :inputStyle="inputStyle">
