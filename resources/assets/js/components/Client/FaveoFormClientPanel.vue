<template>
	...
	<div :id="formId" class="pt-0">
		...
		<FormWithCaptcha v-if="formUniqueKey && formSelected" btnClass='btn btn-custom pull-end text-white' btnName="submit"
										 componentName="faveo-form" :loading="!showLoader"
										 btn_id="client-ticket-submit-button" :formSubmit="formSubmit" :page="formId === 'chat-widget' ? 'chat-widget' : category+'_create_client'"
