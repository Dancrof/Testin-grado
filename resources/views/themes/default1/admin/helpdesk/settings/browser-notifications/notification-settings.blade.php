	...
	<div class="container well well-lg row">
		...
		<!-- <form id="browser-notification-setting" url="{{url('browser-notification/edit')}}" method="POST"> -->
			...
			<div class="col-md-10 col-xs-6 col-sm-6">
				@if($data->enabled)
					<input class="notification-enabled" name="enabled" type="checkbox" checked  data-bs-toggle="toggle"><br><br>
				@else
					<input class="notification-enabled" name="enabled" type="checkbox" data-bs-toggle="toggle"><br><br>
				@endif
				<div>
