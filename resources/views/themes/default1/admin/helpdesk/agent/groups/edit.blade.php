    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 form-group {{ $errors->has('group_status') ? 'has-error' : '' }}">
                {!! Form::label('group_status',Lang::get('lang.status')) !!}&nbsp;<a href="#" data-bs-toggle="tooltip" title="{!! Lang::get('tooltip.permission-status') !!}"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>
                <div class="row">
                    <div class="col-xs-2">
        ...
        <!-- can create ticket -->
        <label>{{Lang::get('lang.access-permissions')}}</label>&nbsp;<a href="#" data-bs-toggle="tooltip" title="{!! Lang::get('tooltip.access-permissions') !!}"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>
        <div class="row">
