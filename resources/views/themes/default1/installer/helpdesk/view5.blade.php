...
<div ng-app="myApp">
        ...
        {!! html()->form('POST', route('license-code'))->id('postaccount')->open() !!}
    ...
    <div ng-controller="MainController"> 
            <table>                
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! html()->text('Lastname', null)->style('margin-left:250px')->required() !!}
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! html()->email('email', null)->style('margin-left:250px; text-transform: lowercase;')->required() !!}
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!! html()->text('username', null)->style('margin-left:250px; text-transform: lowercase;')->required() !!}
            ...
            <table>
                ...
                <div>
                    ...
                    <tr>
                        <td>
                            {!! html()->label(Lang::get('lang.environment'), 'environment') !!}
                        </td>
                        <td>
                            <div  style="margin-left: 230px;">
                    ...
                    <tr>
                        <td>
                            {!! html()->label(Lang::get('lang.probe_storage_driver'), 'probe_storage_driver') !!}
                        </td>
                        ...
                        <tr class="hiddenCredentials">
                            ...
                            <td>
                                {!! html()->text('aws_access_key_id', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenInput') !!}
                            </td>
                        ...
                        <tr class="hiddenCredentials">
                            ...
                            <td>
                                {!! html()->text('aws_access_key', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenInput') !!}
                        ...
                        <tr class="hiddenCredentials">
                            ...
                            <td>
                                {!! html()->text('aws_default_region', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenInput') !!}
                        ...
                        <tr class="hiddenCredentials">
                            ...
                            <td>
                                {!! html()->text('aws_bucket', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenInput') !!}
                            </td>
                    ...
                    <tr class="hiddenCredentials">
                        ...
                        <td>
                            {!! html()->text('aws_endpoint', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenInput endpoint') !!}
                        </td>

                    </tr>
                    <tr>
                       <td>
                           {!! html()->label(Lang::get('lang.cache_driver'), 'cache_driver') !!}
                       </td>
                        <td>
                    ...
                    <tr class="hiddenCacheCredentials">
                        ...
                        <td>
                            {!! html()->text('redis_host', null)->style('margin-left:230px;width:295px')->required()->attribute('class', 'hiddenRedisInput') !!}
                        </td>
                    ...
                    <tr class="hiddenCacheCredentials">
                        ...
                        <td>
                            {!! html()->number('redis_port', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenRedisInput')->attribute('onkeydown', 'return event.keyCode !== 69') !!}
                        </td>
                    ...
                    <tr class="hiddenCacheCredentials">
                        ...
                        <td>
                        {!! html()->text('redis_username', null)->style('margin-left:230px;width:295px')->required(false)->attribute('class', 'hiddenRedisInput') !!}
                    </tr>
                    <tr class="hiddenCacheCredentials">
