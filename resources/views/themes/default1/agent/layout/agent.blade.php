...
<html ng-app="fbApp">
    ...
    <head>
        ...
        <!-- Bootstrap 3.4.1 -->
            <link href="{{assetLink('css','bootstrap-5')}}" rel="stylesheet" type="text/css" id="bootstrapLTR"/>
            <link href="{{assetLink('css','adminlte-4')}}" rel="stylesheet" type="text/css" id="adminLTR"/>
            ...
            <div class="content-wrapper">
             ...
             <footer class="main-footer">
                 ...
                 <!-- <div style="position: fixed;right:0;bottom:0">
                    <button data-bs-toggle="control-sidebar" onclick="openSlide()" style="margin-right:20px"  class="btn btn-primary helpsection">
