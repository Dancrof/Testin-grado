    ...
    <div class="box box-info" ng-controller="dashboardFilterCtrl">
        <div class="box-header with-border ">
            ...
            <div class="pull-right dropdown">
                <a class="dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void()" ng-click="getCustomFields($event)">
                    <i class="fa fa-plus">
        ...
        <div class="box-body" id="department-statics">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a data-bs-toggle="tab" href="#tab_1" id="departments" onclick="pushData('departments')">
                        {!! Lang::get('lang.departments') !!}
                    </a>
                </li>
                <li>
                    <a data-bs-toggle="agents" href="#tab_2" id="agents" onclick="pushData('agents')">
                        {!! Lang::get('lang.agents') !!}
                    </a>
                </li>
                <li>
                    <a data-bs-toggle="teams" href="#tab_3" id="teams" onclick="pushData('teams')">
                        {!! Lang::get('lang.teams') !!}
                    </a>
                </li>
                @for ($i = 3; $i < count($dashboard_statistics); $i++)
                    <li>
                        <a data-bs-toggle="{!! $dashboard_statistics [$i]!!}" href="#tab_{!! $i !!}" id="{!! $dashboard_statistics [$i]!!}" onclick="pushData('{!! $dashboard_statistics [$i]!!}')">
