            ...
            <div class="col-md-12">
                        ...
                        <div class="card card-light">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button class="btn btn-tool" data-card-widget="collapse" data-bs-toggle="tooltip" title="{{Lang::get('lang.collapse-list')}}"><i class="fas fa-minus"></i></button>
                                </div><!-- /.box-tools -->
                            </div><!-- /.box-header -->
                            <div class="card-body col-md-12">
                                ...
                                <div>
                                    <ul class="list-inline ">
                                        ...
                                        <li  class="list-inline-item" style="width: 23%"><span data-bs-toggle="tooltip" title="{{trans($value)}}" data-placement="right">{{$key}}</span></li>
                                        @endforeach   
                                    </ul>
                                </div>
                                <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-3 form-group" id = "use-subject">
                        ...
                        {!! Form::label('subject',Lang::get('lang.use_subject')) !!} <a href="#" data-bs-toggle="tooltip" title="{!! Lang::get('lang.template-subject-usage-info') !!}"><i class="fa fa-question-circle" style="padding: 0px;"></i></a>
                    </div>
                </div>
                <div class="row">
