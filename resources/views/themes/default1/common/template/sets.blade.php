...
<div class="card card-light">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button class="btn btn-tool" data-bs-toggle="modal" data-bs-target="#create" title="Create" id="2create"
                title="{{Lang::get('lang.create_template')}}" data-bs-toggle="tooltip">
                ...
                <tr>
                    ...
                    <td style="width: 235px">
                        ...
                        @if($set->active == 1 && $set->id == 1)
                           <button class="btn btn-primary btn-xs disabled" data-bs-toggle="modal" data-bs-target="">
                        ...
                        ?>
                        <button class="btn btn-primary btn-xs {!! $dis !!}" data-bs-toggle="modal" data-bs-target="#deleteset-{{$set->id}}{!! $dis !!}">
