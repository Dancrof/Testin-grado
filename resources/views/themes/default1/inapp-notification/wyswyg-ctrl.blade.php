...
<div style="margin-bottom: 9px;">
    <button type="button" class="btn btn-default" data-bs-toggle="modal" data-bs-target="#myModal" style="border-radius: 0px;background-color: #f0f0f0;" ng-click="getImageApi()"><i class="fa fa-caret-square-o-right" style="margin-right: 5px"></i>&nbspAdd Media&nbsp</button>
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="padding-left: 0px;padding-right: 0px;">
                            ...
                            <ul class="nav nav-tabs" id="mytabs">
                                <li><a data-bs-toggle="tab" href="#upload" ng-click="noInsert()" style="margin-right: 0px">Upload Files</a></li>
                                <li class="active"><a data-bs-toggle="tab" href="#menu1" style="margin-right: 0px">Media Library</a></li>
                            </ul>
              ...
              width="130px" height="130px" style="vertical-align: inherit;object-fit: cover;background-color: gainsboro;border: 1px solid #c1c1c1" />
               <img ng-switch-when="audio" src="{{assetLink('image','audio')}}" width="130px" height="130px" style="vertical-align: inherit;object-fit: cover;background-color: gainsboro;border: 1px solid #c1c1c1" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-md" ng-disabled="$root.disable"  data-bs-toggle="modal" data-bs-target="#deletelib">Delete</button>
                </div>
            </div>
