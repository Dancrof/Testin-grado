                            ...
                            <div class="box-body">
                                <ul class="todo-list">
                                    ...
                                    <li class="task">
                                        ...
                                        <label for='cl'  data-bs-toggle="tooltip"  data-placement="top" title="Mark Read"><span></span>&nbsp<img src="{{$notification->users-> profile_pic}}" class="img-circle" style="width:25px;height: 25px" alt="User Image" />
                                            <!-- todo text -->
                                        ...
                                        <div class="tools">
                                            <a href="{!! route('user.show', $notification -> notification_id) !!}"  data-bs-toggle="tooltip"  data-placement="top" title="View" id="{{$notification -> notification_id}}" class='noti_User'><i class="fa fa-eye"></i></a>
                                            <a href="#" id='{{ $notification -> notification_id }}' data-bs-toggle="tooltip"  data-placement="top" title="Delete" class='notification-delete clickfun'><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </li>
                                    @else
                                    <li>
                                    ...
                                    <li class="task">
                                        <input type="checkbox" value="" name="cc"  data-bs-toggle="tooltip"  data-placement="top" title="Mark Read" class="noti_User clickfun" id="{{$notification -> notification_id}}">
                                        <label for='cl'><span></span>&nbsp<img src="{{$notification->users-> profile_pic}}" class="img-circle"  style="width:25px;height: 25px" alt="User Image" />
                                            ...
                                            <a href="{!! route('ticket.thread', $notification->notification->model_id) !!}" id='{{ $notification -> notification_id }}'  data-bs-toggle="tooltip"  data-placement="top" title="View" class='noti_User'><i class="fa fa-eye"></i></a>
                                            <a href="#" id='{{ $notification -> notification_id }}' data-bs-toggle="tooltip"  data-placement="top" title="Delete" class='notification-delete clickfun'><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </li>
